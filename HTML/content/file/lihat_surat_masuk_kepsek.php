                                    ...
                                    echo "<tr >";
                                        ...
                                        echo "<td >
                                                ...
                                                <div style='margin:0 auto 5px auto; text-align:center;' class='btn-group btn-group-vertical'>
                                                    ...
                                                    <a style='margin: 5px 0px; border-radius:5px;' href = 'halaman.php?s=form_disposisi_masuk_kepsek&id=$row[id_surat_masuk]' class='btn btn-sm btn-success '>Disposisi</a>
                                                </center>
                                                </div>
                                            </td>";
                                        // echo "</div>";
