<div class="wrapper">
    <div class="container-fluid">
        ...
        <div>
            <form target="_blank" action='content/file/cetak_hasil_disposisi.php'>
                <div class="sorting_input">
                    <button type='submit' class="btn btn-sm btn-primary square-btn-adjust btn-sorting">Cetak Hasil Disposisi</button>
                </div>
            </form>
        </div>
        <br>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div>
                              &nbsp;&nbsp;
                              <a href="halaman.php?s=lihat_surat_masuk_admin" class="btn btn-sm btn-primary square-btn-adjust">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
