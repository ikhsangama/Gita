...
<tr>
    <td>
        <h3>
            <center>REKAPITULASI SURAT KELUAR</center>
        </h3>
    </td>
</tr>
<tr>
    <td>
        <h2>
            <center>SMA NEGERI 1 TEGAL</center>
        </h2>
    </td>
</tr>
<tr>
    <td>
        <h5>
            <center>Jalan Menteri Supeno No.16 Telp: (0283) 353498 Fax: (0823) 323955 Tegal
                <br>Website: www.sman1tegal.sch.id Email: sman1_kotategal@yahoo.com
            </center>
        </h5>
    </td>
</tr>
