                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <form action="content/server/add_surat_masuk_admin.php" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" pattern="^\S+$" name="no_hal_surat"
                                                   required/>
                                        </div>
                                        <!-- <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" id="tgl_surat"
                                                   name="tgl_surat_diterima" required onchange="checkDate()"
                                                   max="<?php echo date("Y-m-d") ?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label>No. Surat Masuk</label>
                                            <input class="form-control" type="text" pattern="^\S+$"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status_surat" required>
                                                ...
                                                <option value="Belum Disposisi"/>
                                                Belum Disposisi </option>
                                            </select>
                                        </div>
