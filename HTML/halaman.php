    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right">
          ...
          <h5 class="centered" style="font-size: 16px; color: #DCDCDC;"><span class="nav-link-text"><?php echo $user['nama']; ?></span></h5>
          <br>
        </li>
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a href="content/server/logout.php" class="nav-link" data-toggle="modal" data-target="#exampleModal" style="color: #DCDCDC;">
